...
const file_forge_v1_forge_proto_rawDesc = "" +
	...
	"\rauth_provider\x18\x02 \x01(\tR\fauthProvider\"\xb2\x01\n" +
	"\rMethodOptions\x12#\n" +
	"\rauth_required\x18\x01 \x01(\bR\fauthRequired\x12\x1e\n" +
	"\n" +
	"idempotent\x18\x03 \x01(\bR\n" +
	"idempotent\x123\n" +
	"\atimeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x12'\n" +
	"\x0fidempotency_key\x18\x05 \x01(\bR\x0eidempotencyKey\"\xa4\x01\n" +
	...
	"\x06method\x12\x1e.google.protobuf.MethodOptions\x18\xb4\x87\x03 \x01(\v2\x17.forge.v1.MethodOptionsR\x06methodB\x8f\x01\n" +
	"\fcom.forge.v1B\n" +
	"ForgeProtoP\x01Z2github.com/reliant-labs/forge/gen/forge/v1;forgev1\xa2\x02\x03FXX\xaa\x02\bForge.V1\xca\x02\bForge\\V1\xe2\x02\x14Forge\\V1\\GPBMetadata\xea\x02\tForge::V1b\x06proto3"
