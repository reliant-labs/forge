...
description: Code hygiene review methodology — correctness bugs, test quality issues, LLM antipatterns, and migration safety checklist
---
...
## Review Guidelines
- Be thorough about error handling
...
- Keep suggestions proportional to the change. For trivial changes (CSS, copy, config), focus only on obvious issues in the changed code. Do not review surrounding unchanged code.
