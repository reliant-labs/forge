...
const variantConfig: Record<AlertVariant, { bg: string; border: string; icon: string; title: string; text: string }> = {
  info: { bg: "bg-accent-surface", border: "border-accent-border", icon: "text-accent", title: "text-accent-ink", text: "text-accent-ink" },
  success: { bg: "bg-success-surface", border: "border-success-border", icon: "text-success", title: "text-success-ink", text: "text-success-ink" },
  warning: { bg: "bg-warning-surface", border: "border-warning-border", icon: "text-warning", title: "text-warning-ink", text: "text-warning-ink" },
  error: { bg: "bg-danger-surface", border: "border-danger-border", icon: "text-danger", title: "text-danger-ink", text: "text-danger-ink" },
};
    ...
    <div className={`rounded-lg border p-4 ${config.bg} ${config.border}`} role="alert">
      <div className="flex items-start gap-3">
        ...
        {dismissible && (
          ...
          <button type="button" aria-label="Dismiss" onClick={handleDismiss} className={`flex-shrink-0 ${config.icon} hover:opacity-70`}>
