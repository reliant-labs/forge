...
const file_forge_v1_forge_proto_rawDesc = "" +
	...
	"\x04role\x18\b \x01(\x0e2\x19.forge.v1.ConfigFieldRoleR\x04role*q\n" +
	"\aStoreAs\x12\x18\n" +
	...
	"\x1bSERVICE_VISIBILITY_INTERNAL\x10\x02*P\n" +
	"\x0fConfigFieldRole\x12!\n" +
	"\x1dCONFIG_FIELD_ROLE_UNSPECIFIED\x10\x00\x12\x1a\n" +
	"\x16CONFIG_FIELD_ROLE_MODE\x10\x01:R\n" +
